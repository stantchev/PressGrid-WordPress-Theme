<?php
/**
 * Latest Posts section — 3-col grid + sidebar
 *
 * @package PressGrid
 */
...
$layout     = sanitize_key( $args['layout']     ?? 'grid-3' );
$category   = absint(       $args['category']   ?? 0 );
$post_count = absint(       $args['post_count'] ?? 6 );
...
$grid_map   = array( 'grid-2' => 'pg-grid-2', 'grid-3' => 'pg-grid-3', 'grid-4' => 'pg-grid-4', 'list' => 'pg-grid-1' );
$grid_class = $grid_map[ $layout ] ?? 'pg-grid-3';
